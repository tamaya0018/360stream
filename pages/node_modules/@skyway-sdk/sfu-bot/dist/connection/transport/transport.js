...
class SfuTransport {
    constructor(msTransport, _bot, _iceManager, _sfuApi, _context) {
        ...
        this.restartIce = () => __awaiter(this, void 0, void 0, function* () {
            ...
            e = yield this._waitForMsConnectionState('connected', this._options.peerConnectionJitterTimeout).catch((e) => e);
            if (!e && checkNeedEnd()) {
                ...
                case 'failed':
                    {
                        ...
                        const e = yield this._waitForMsConnectionState('connected', this._options.peerConnectionJitterTimeout).catch((e) => e);
                        if (e &&
